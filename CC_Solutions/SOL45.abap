...
SELECT * FROM spfli INTO wa_spfli WHERE carrid in s_carrid.
  WRITE:/, 1 'City from', 21 'City to',41 'Connection ID', 61 'Carrier'.
  WRITE:/, 1 wa_spfli-cityfrom, 21 wa_spfli-cityto, 41 wa_spfli-connid, 61 wa_spfli-carrid.
  ULINE.
